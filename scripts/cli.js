...
const contractABI = require("../artifacts/contracts/N8nworkflow.sol/N8nworkflow.json").abi;

program
    .name("n8nworkflow-cli")
    .description("CLI tool for N8nworkflow smart contract")
    .version("1.0.0");
